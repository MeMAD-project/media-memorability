...
parser.add_argument("-t", "--test_set_path", type=str, help="Path to the CSV file containing video descriptions of the testset.", default="data_2021/TRECVid Data/test_set/test_text_descriptions.csv")
